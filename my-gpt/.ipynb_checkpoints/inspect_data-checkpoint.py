...
#     # Pick random starting locations in the text
#     ix = torch.randint(
#         0,
#         len(data) - block_size,
#         (batch_size,)
...
#     # x contains characters
#     x = torch.stack([
#         data[i:i + block_size]
#         for i in ix
#     ])

#     # y contains the character immediately after each x character
#     y = torch.stack([
#         data[i + 1:i + block_size + 1]
#         for i in ix
#     ])

#     # Move the batch to the Intel GPU
#     x = x.to(device)
#     y = y.to(device)
...
# print("Expected:", vocab_size * vocab_size)
